...
|---------|-------------|------|
| Users & Identity | Google sign-in, household model | [identity.md](identity.md) |
| Recipe Storage | Structured Markdown recipes, revision history, manual entry | [recipes.md](recipes.md) |
| Meal Planning | Flexible weekly scheduling, recipe selection | [meal-planning.md](meal-planning.md) |
| Shopping List | Consolidated lists, checkout flow | [shopping.md](shopping.md) |
