...
- Smart ingredient merging: parse quantities and units, combine matching ingredients (e.g., "1 cup rice" + "2 cups rice" = "3 cups rice")
- Each merged line cites its source recipes so you know where ingredients will be used
